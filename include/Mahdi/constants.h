...
#define  VERSION                        "0.02.065"    //X.Y.Z=> Z<100,Y<10
#define  VERSION_NUMBER                 26          //XYZ=>(X*100)+(Y*10)+(Z/10)
...
#define   INVALID_STRING_VAL_ERRC       8
...
#define   INVALID_MODULE_FUNC_ERRC      14
#define   BAD_FUNC_PARAMS_ERRC          15
